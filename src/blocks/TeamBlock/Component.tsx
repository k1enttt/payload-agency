        ...
        <div className="container py-8 lg:px-6 sm:py-16 lg:py-24">
          <div className="max-w-5xl">
            ...
            <p className="mt-4 text-base font-normal text-gray-500 sm:text-xl dark:text-gray-400">
              ...
              velocity. Respond to changes and deliver great customer and employee service
              experiences fast.
            </p>
            <div className="mt-4">
              <a
          ...
          <div className="grid grid-cols-1 mt-12 gap-y-12 gap-x-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
            <div>
              <Image
              ...
              <div className="mt-4 space-y-2">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Bonnie Green</h3>
            ...
            <div>
              ...
              <div className="mt-4 space-y-2">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Roberta Casas</h3>
                  <p className="text-base font-medium text-gray-500 dark:text-gray-400">
                    CTO & Co-Founder
                  </p>
                </div>
            ...
            <div>
              ...
              <div className="mt-4 space-y-2">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Robert Brown</h3>
                  <p className="text-base font-medium text-gray-500 dark:text-gray-400">
            ...
            <div>
              ...
              <div className="mt-4 space-y-2">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Neil Sims</h3>
                  <p className="text-base font-medium text-gray-500 dark:text-gray-400">
                    Graphic Designer
                  </p>
                </div>
            ...
            <div>
              ...
              <div className="mt-4 space-y-2">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Thomas Lean</h3>
                  <p className="text-base font-medium text-gray-500 dark:text-gray-400">
                    Accountant
                  </p>
                </div>
            ...
            <div>
              ...
              <div className="mt-4 space-y-2">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Jese Leos</h3>
                  <p className="text-base font-medium text-gray-500 dark:text-gray-400">
                    SEO Specialist
                  </p>
                </div>
            ...
            <div>
              ...
              <div className="mt-4 space-y-2">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Karen Nelson</h3>
                  <p className="text-base font-medium text-gray-500 dark:text-gray-400">
                    Marketing
                  </p>
                </div>
            ...
            <div>
              ...
              <div className="mt-4 space-y-2">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Helene Engels</h3>
                  <p className="text-base font-medium text-gray-500 dark:text-gray-400">Support</p>
                </div>
                <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                  Bonnie drives the technical strategy of the themesberg platform and brand.
                </p>
          ...
          <div className="max-w-3xl p-4 mx-auto mt-8 rounded-md lg:mt-12 bg-gray-50 dark:bg-gray-800">
            <div className="flex flex-col justify-between gap-3 md:gap-6 md:items-center md:flex-row">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-base font-normal text-gray-700 dark:text-gray-400">
                  <span className="font-semibold">Want to join be a part of us?</span>
